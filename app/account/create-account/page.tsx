...
export default function CreateAccount() {
  return (
    <div>
      ...
      <div className="absolute left-1/2 top-20 mt-10 w-full max-w-[500px] -translate-x-1/2 bg-zinc-900 p-5">
        <form className="flex flex-col gap-4">
          <input placeholder="Nome" className="w-full border border-zinc-700 bg-zinc-900 px-4 py-2" />
          <input placeholder="Sobrenome" className="w-full border border-zinc-700 bg-zinc-900 px-4 py-2" />
